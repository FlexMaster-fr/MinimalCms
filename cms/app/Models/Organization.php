...
class Organization extends Model
{
    ...
    public function getRepositories(array $options = []): array
    {
        ...
        $query = "SELECT r.*, l.name as language_name, l.color as language_color, 
                ...
                WHERE r.owner_id = :owner_id AND r.owner_type = 'Organization'
        ...
        $countQuery = "SELECT COUNT(*) as count FROM repositories 
                      WHERE owner_id = :owner_id AND owner_type = 'Organization'";
    ...
    /**
     * Get popular repositories for this organization
     * 
    ...
    /**
     * Get profile README for this organization
     * 
    ...
    /**
     * Find an organization by GitHub login
     * 
     * @param string $login GitHub login
     * @return static|null Organization instance or null if not found
     */
    ...
    /**
     * Find an organization by GitHub ID
     * 
     * @param int $githubId GitHub organization ID
     * @return static|null Organization instance or null if not found
     */
    public static function findByGithubId(int $githubId): ?static
    {
        $query = "SELECT * FROM organizations WHERE github_id = :github_id LIMIT 1";
    ...
    /**
     * Get stats summary for this organization
     * 
    ...
    public static function search(string $query, array $options = []): array
    {
        ...
        // Build search query
        if (!empty($query)) {
            $where[] = "(login LIKE :query OR name LIKE :query OR description LIKE :query)";
            $params['query'] = "%$query%";
        }
        ...
        // Get total count
        $countSql = "SELECT COUNT(*) as count FROM organizations";
